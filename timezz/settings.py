"""
Django settings for timezz project.
...
SECRET_KEY = 'django-insecure-4=h*yt^kbx-czeha%+o7ki)d^8^xb2#4^w(!z8c3_1j(8a($^#'
...
WSGI_APPLICATION = 'timezz.wsgi.application'
